...
export const RANKS = [
    ...
    { id: 3, range: '2,800+ EXP', minExp: 2800, name: 'BINARY APPRENTICE', icon: rank3, color: 'text-lime-400', border: 'border-lime-500/50', bg: 'bg-lime-500/10' },
    { id: 4, range: '8,000+ EXP', minExp: 8000, name: 'SYNTAX SOLDIER', icon: rank4, color: 'text-teal-400', border: 'border-teal-500/50', bg: 'bg-teal-500/10' },
    ...
    { id: 8, range: '78,000+ EXP', minExp: 78000, name: 'SYSTEM SENTINEL', icon: rank8, color: 'text-emerald-400', border: 'border-emerald-500/50', bg: 'bg-emerald-500/10' },
    { id: 9, range: '150,000+ EXP', minExp: 150000, name: 'ELITE COMPILER', icon: rank9, color: 'text-cyan-400', border: 'border-cyan-500/50', bg: 'bg-cyan-500/10' },
    { id: 10, range: '300,000+ EXP', minExp: 300000, name: 'GRANDMASTER HACKER', icon: rank10, color: 'text-purple-400', border: 'border-purple-500/50', bg: 'bg-purple-500/10' },
    { id: 11, range: '500,000+ EXP', minExp: 500000, name: 'APEX LEGEND', icon: rank11, color: 'text-rose-400', border: 'border-rose-500/50', bg: 'bg-rose-500/10' },
    { id: 12, range: '999,000+ EXP', minExp: 999000, name: 'SIEGE DEITY', icon: rank12, color: 'text-amber-400', border: 'border-amber-500/50', bg: 'bg-amber-500/10' },
];
