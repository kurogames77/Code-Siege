...
import towerFloorBg from '../assets/TowerView6.png'; // Aeterd background
import buttonDot from '../assets/buttondot.png';

import arrow from '../assets/arrow.png';

const TowerAeterdView = () => {
    const id = '6';
    const navigate = useNavigate();
    const { user } = useUser();
    const { playClick, playCancel } = useSound();

    const [towerClosed, setTowerClosed] = useState(true);
    ...
    useEffect(() => {
        const checkAvailability = async () => {
            try {
                ...
                const course = courses.find(c => c.id === 'php');
    ...
    const towerData = {
        ...
        '6': { name: 'Tower of Aeterd', totalFloors: 30 },
    };

    const baseTower = towerData[id] || {
        name: 'Tower of Aeterd',
        totalFloors: 30,
    };
    ...
    const basePositions = [
        ...
        { floor: 3, top: '98%', left: '25%', label: 'LEVEL 4' },
        { floor: 4, top: '107%', left: '51%', label: 'LEVEL 1' },
        { floor: 5, top: '93%', left: '84%', label: 'LEVEL 5' },
        { floor: 6, top: '89%', left: '51%', label: 'LEVEL 7' },
        { floor: 7, top: '93%', left: '22%', label: 'LEVEL 6' },
        { floor: 8, top: '79%', left: '25%', label: 'LEVEL 8' },
        { floor: 9, top: '35%', left: '23%', label: 'LEVEL 28' },
        { floor: 10, top: '75%', left: '64%', label: 'LEVEL 11' },
        { floor: 11, top: '79%', left: '75%', label: 'LEVEL 10' },
        { floor: 12, top: '79%', left: '40%', label: 'LEVEL 9' },
        { floor: 13, top: '29%', left: '37%', label: 'LEVEL 29' },
        { floor: 14, top: '74%', left: '51%', label: 'LEVEL 12' },
        { floor: 15, top: '67%', left: '78%', label: 'LEVEL 13' },
        { floor: 16, top: '67%', left: '63%', label: 'LEVEL 14' },
        { floor: 17, top: '67%', left: '37%', label: 'LEVEL 15' },
        { floor: 18, top: '67%', left: '22%', label: 'LEVEL 16' },
        { floor: 19, top: '35%', left: '60%', label: 'LEVEL 27' },
        { floor: 20, top: '56%', left: '75%', label: 'LEVEL 19' },
        { floor: 21, top: '56%', left: '28%', label: 'LEVEL 18' },
        { floor: 22, top: '63%', left: '51%', label: 'LEVEL 17' },
        { floor: 23, top: '35%', left: '78%', label: 'LEVEL 26' },
        { floor: 24, top: '52%', left: '51%', label: 'LEVEL 20' },
        { floor: 25, top: '45%', left: '78%', label: 'LEVEL 21' },
        { floor: 26, top: '45%', left: '63%', label: 'LEVEL 22' },
        { floor: 27, top: '45%', left: '37%', label: 'LEVEL 23' },
        { floor: 28, top: '45%', left: '22%', label: 'LEVEL 24' },
        { floor: 29, top: '41%', left: '51%', label: 'LEVEL 25' },
        { floor: 30, top: '10%', left: '51%', label: 'LEVEL 30' },
    ];
                ...
                <div className="fixed top-0 left-0 right-0 h-48 z-40 pointer-events-none">
                    <div className="absolute top-28 left-8 pointer-events-auto">
                        <button onClick={() => { playClick(); navigate('/play'); }}
                            ...
                            <LayoutGrid className="w-9 h-9" /> BACK TO MAP
                        </button>
                    </div>
                </div>
            ...
            <main className="pt-48 pb-40 px-6 max-w-4xl mx-auto flex flex-col items-center">
                ...
                >
                    ...
                    <p className="text-white font-normal uppercase text-2xl tracking-[0.2em] font-galsb drop-shadow-md">
                        LEARN PHP LANGUAGE IN THIS TOWER
                    </p>
                </motion.div>
                                ...
                                >
                                    <motion.div
                                        ...
                                        onClick={() => {
                                            if (isCurrent) {
                                                playClick();
                                                navigate(`/gamecode-aeterd/${labelNum}/${id}`);
                                            } else if (!isCleared) {
                                                playCancel();
                                            }
                                        }}
...
export default TowerAeterdView;
