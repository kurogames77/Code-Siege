...
const GameCodePrytody = () => {
    ...
    // Check if course levels exist for JavaScript (Tower 4)
    useEffect(() => {
    ...
    const handleNextLevel = () => {
        ...
        navigate(`/gamecode-prytody/${nextFloor}/${towerId}`);
    };
            ...
            {!showPostScene && (
                <div className="fixed top-0 left-0 right-0 h-48 z-40 pointer-events-none">
                    <div className="absolute top-26 left-8 pointer-events-auto">
                        <button
                            onClick={() => navigate(`/tower-prytody`)}
                                    ...
                                    <div className="w-56">
                                        ...
                                        <AnimatePresence>
                                            {openLangDropdown && (
                                                ...
                                                >
                                                    {languages.map((lang) => {
                                                        const isDisabled = lang !== 'Python (Rec.)';
                                                        return (
                                                            <div
                                                                key={lang}
...
export default GameCodePrytody;
