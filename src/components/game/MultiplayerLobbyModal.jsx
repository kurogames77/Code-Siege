                                                ...
                                                <div key={i} className="relative group w-44 h-[520px] shrink-0">
                                                    ...
                                                    {player ? (
                                                        <>
                                                            ...
                                                            <div className={`absolute inset-x-[-20%] bottom-16 top-16 z-10 pointer-events-none flex items-end justify-center ${isGrey ? 'opacity-50' : 'opacity-100'}`}>
                                                                <motion.img
                                                                    initial={{ scale: 1.0 }}
                                                                    animate={{ scale: isGrey ? 0.95 : 1.0 }}
                                                                    src={player.heroImage || player.avatar}
                                                                    className={`w-full max-h-full object-contain object-bottom transition-all duration-700 drop-shadow-[0_20px_40px_rgba(0,0,0,0.6)] ${isGrey ? 'brightness-50 grayscale' : 'brightness-110'}`}
                                                                    alt="Hero"
                                                                />
                                                            </div>
