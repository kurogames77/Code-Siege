...
const QUEST_POOL = [
    ...
    { id: 'q3', title: '[Invincible] Complete 2 Ranked match(es).', target: 2, action: 'match_complete_ranked', reward: { exp: 40, gold: 0 } }, // 'ranked' flag needed in update? Or just general 'match_complete' if ranked not specific yet
    { id: 'q4', title: '[Game Master] Get a Silver Medal or above 1 time(s).', target: 1, action: 'get_medal_silver', reward: { exp: 30, gold: 0 } },
    { id: 'q5', title: '[Team Player] Get 5 Assists in a single match.', target: 5, action: 'assist', reward: { exp: 50, gold: 0 } },
    ...
    { id: 'q8', title: '[Survivor] Survive for 10 minutes in a match.', target: 10, action: 'survival_time', reward: { exp: 30, gold: 0 } }, // minutes?
    ...
    { id: 'q14', title: '[Big Spender] Spend 100 Gems in the Shop.', target: 100, action: 'spend_gems', reward: { exp: 20, gold: 0 } },
    ...
    { id: 'q17', title: '[Polyglot] Submit code in 2 different languages.', target: 2, action: 'submit_language', unique: true, reward: { exp: 40, gold: 0 } }, // unique check needed
...
export const QuestProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const storageKey = `daily_quests_${user.id}_${dateStr}`;
